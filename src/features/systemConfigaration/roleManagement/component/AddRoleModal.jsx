              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-surface/50 border-b border-surface-border">
                    <th className="py-2.5 pl-5 text-left text-xs font-semibold text-slate-600 w-16">
                      Select
                    </th>
                    <th className="py-2.5 text-left text-xs font-semibold text-slate-600">
                      Webpage name
                    </th>
                    <th className="py-2.5 pr-5 text-left text-xs font-semibold text-slate-600 w-16">
                      Details
                    </th>
                  </tr>
                </thead>
                  ...
                  {pages.map((page) => (
                    ...
                    >
                      <td className="py-2.5 pl-5">
                        <input
                          type="checkbox"
                          checked={!!form.permissions[page]}
                          onChange={() => togglePermission(page)}
                          className="w-4 h-4 rounded border-slate-300 accent-primary cursor-pointer"
                        />
                      </td>
                      <td className="py-2.5 text-slate-700">{page}</td>
