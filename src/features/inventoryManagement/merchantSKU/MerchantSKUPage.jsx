    ...
    <div className="space-y-4 font-body">
      ...
      <div className="bg-white rounded-xl border border-surface-border overflow-hidden">
                    ...
                    <td className="py-3 pr-5">
                      ...
                      >
                        ...
                        <PortalActionMenu
                          ...
                          anchorRef={{ current: actionRefs.current[sku.id] }}
        ...
        <div className="flex justify-end gap-3 px-5 py-4 border-t border-surface-border">
          <button onClick={() => exportRowsToCsv(products.filter((sku) => selectedIds.includes(sku.id)), [
          ...
          ], 'merchant-sku-list.csv', 'merchant SKU')} className="flex items-center gap-2 px-14 py-2.5 text-base font-semibold border border-surface-border rounded-lg text-slate-700 bg-white hover:bg-surface-card transition-colors">
