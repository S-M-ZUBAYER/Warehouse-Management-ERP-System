...
export default function ManualOrderDetailModal({ open, order, onClose, onPrintWaybill }) {
      ...
      <div className="max-h-[92vh] w-full max-w-[1180px] overflow-hidden rounded-2xl bg-white shadow-2xl">
        ...
        <div className="max-h-[76vh] overflow-y-auto p-6 space-y-4">
          ...
          <div className="grid gap-4 lg:grid-cols-2">
            ...
            <Section title="EasyParcel / Shipment">
              ...
              <Row label="AWB" value={order.awbNumber || order.trackingNo} />
              <Row label="Provider Order" value={order.providerOrderNumber} />
              <Row label="Provider Shipment" value={order.providerShipmentNumber} />
              <Row label="Raw Provider Status" value={order.rawProviderStatus} />
              <Row label="Tracking URL" value={order.trackingUrl} />
