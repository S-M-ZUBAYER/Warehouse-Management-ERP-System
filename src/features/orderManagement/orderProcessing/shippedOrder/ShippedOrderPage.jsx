...
export default function ShippedOrder() {
  ...
  const restoredPageState = useMemo(
    () => getStoredOrderListReturnState({ pathname: location.pathname, navigationType, pageType: "shipped" }),
  ...
  const list = useOrderList({
    ...
    datePreset,
    dateRange,
    showAllShopeeShipped: restoredPageState.showAllShopeeShipped ?? dashboardFilter.showAllShopeeShipped,
  });
