...
// Shows selected SKUs list + form fields for the new combined SKU
// ─────────────────────────────────────────────────────────────────────────────
          ...
          {selectedSkus.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-10 text-center">
              ...
              <p className="text-sm text-slate-400">
                Select SKUs from the left panel
              </p>
              {errors.skus && (
                <p className="text-xs text-red-500 mt-1">{errors.skus}</p>
              )}
            </div>
          ) : (
              ...
              >
                ...
                <div className="col-span-2 flex items-center gap-1">
                  <button
                    ...
                    className="w-6 h-6 rounded-md border border-surface-border flex items-center
                               justify-center text-slate-500 hover:bg-surface-card transition-colors"
                  >
                    <Minus size={11} />
                  </button>
