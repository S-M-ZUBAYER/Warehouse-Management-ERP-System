...
// Shows searchable list of SKUs to select from
// ─────────────────────────────────────────────────────────────────────────────
          ...
          skus.map((sku) => {
            ...
            return (
              ...
              >
                {/* Checkbox indicator */}
                <div
                  className={`flex-shrink-0 ${isSelected ? "text-primary" : "text-slate-300"}`}
                >
                  {isSelected ? (
                ...
                <div className="flex-1 min-w-0">
                  <p
                    className={`text-sm truncate font-medium ${isSelected ? "text-primary" : "text-slate-700"}`}
                  >
                    {sku.name}
                  </p>
