...
const { requireWorkflowAccess } = require('../utils/workflowPermissions');
...
router.use('/roles', authenticate, requireWorkflowAccess('role_management'), require('../modules/roles/roles.routes'));
...
router.use('/warehouses', authenticate, requireWorkflowAccess('warehouse_management'), require('../modules/warehouses/warehouses.routes'));
router.use('/merchant-skus', authenticate, requireWorkflowAccess('merchant_sku'), require('../modules/merchantSkus/merchantSkus.routes'));
router.use('/combine-skus', authenticate, requirePageAccess('combine_sku'), require('../modules/combineskus/combineskus.routes'));
router.use('/inventory', authenticate, requireWorkflowAccess('inventory_list'), require('../modules/inventory/inventory.routes'));
router.use('/stock', authenticate, requireWorkflowAccess('stock', 'inventory_list'), require('../modules/stock/stock.routes'));
router.use('/inbound', authenticate, requireWorkflowAccess('inbound'), require('../modules/inbound/inbound.routes'));
router.use('/outbound', authenticate, requirePageAccess('outbound_order'), require('../modules/outbound/outbound.routes'));
router.get('/order-management/platform-stores', authenticate, requirePageAccess('dashboard'), platformStoresController.getPlatformStores);
...
router.use('/platform-stores', authenticate, requireWorkflowAccess('platform_stores', 'store_authorization'), require('../modules/platformStores/platformStores.routes'));
...
router.use('/sku-mapping', authenticate, requireWorkflowAccess('sku_mapping'), require('../modules/skuMapping/skuMapping.routes'));
